...
<div class="container-fluid">
    ...
    <div class="card mb-4">
        <div class="card-body">
            ...
            @endif
            <form action="{{ route('master_logistik.store')}}" method="POST">
                @csrf
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="inputNama" placeholder="Masukan Nama" name="master_logistik_nama" value="{{ old('master_logistik_nama') }}">
                </div>
